...
@interface LYSChartHistogram : UIView
/* 内容边距 */
...
@property (nonatomic,strong)UIColor *histogramClickFillColor;

/* 点击柱状图回调事件 */

@property (nonatomic,copy)void(^histogramClickAction)(NSInteger index);
